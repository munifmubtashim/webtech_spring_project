    ...
    <div class="container">
        ...
        <?php if ($booking): ?>
            <div class="details-box">
                ...
                <div class="detail-row">
                    <span>Check-out</span>
                    <span><?php echo htmlspecialchars($booking['checkout_date']); ?></span>
                </div>
                <div class="detail-row">
                    <span>Guests</span>
                ...
                <div class="detail-row">
                    <span>Status</span>
                    <span><span class="status-badge"><?php echo htmlspecialchars($booking['status']); ?></span></span>
                </div>
                <div class="total-row">
        ...
        <?php else: ?>
            <p style="color:red; text-align:center;">Booking details not found.</p>
        <?php endif; ?>
